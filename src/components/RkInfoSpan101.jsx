function RkInfoSpan101_author(props) {
  return (
    <p><span className="rkinfospan101_icon">
...
export default class RkrkInfoSpan101 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      commentNum: 27
  ...
  render() {
    return (
      <div className="rkinfospan101" role="contentinfo">
        <RkInfoSpan101_author />
        <RkInfoSpan101_date />
        <RkInfoSpan101_category />
        <RkInfoSpan101_comments pr_commentNum={this.state.commentNum}/>      
      </div>
      );
  }
}